...
Se representa la curva de Lorenz que corresponde a los datos
...
son regresivas: se transfiere dinero de un individuo más pobre a uno
más rico. En ambos casos, los índices indican un empeoramiento de la
distribución de la renta con respecto a la situación inicial del
apartado [[item:b]].

Por otro lado, cuando comparamos la distribución de la renta de los
apartados [[item:c]] y [[item:d]] se obtienen resultados diferentes con cada
uno de los índices. Por un lado, el índice de Gini toma el mismo
valor. Por otro lado, el índice /S80S20/ muestra una mayor desigualdad
en el apartado [[item:c]].

Para comparar las transferencias que se han planteado antes es
preferible usara el índice /S80S20/ dado que es más sensible a cambios
en los extremos de la distribución. El índice de Gini no proporciona
una guía útil en este caso.
